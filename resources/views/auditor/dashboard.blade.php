        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    <form class="relative" method="GET" action="{{ route('auditor.dashboard') }}">
                        <label for="aud-search" class="sr-only">Search</label>
                        <input id="aud-search" name="q" value="{{ request('q') }}" class="h-10 w-64 rounded-full border border-emerald-200 bg-white px-10 text-sm placeholder:text-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500" placeholder="Search" />
