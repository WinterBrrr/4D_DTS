        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    <form class="relative" method="GET" action="{{ route('handler.completed') }}">
                    ...
                    <table class="min-w-full divide-y divide-emerald-100">
                        <thead class="bg-emerald-50">
                            <tr>
                                ...
                                <th class="px-3 py-2 text-left text-xs font-semibold text-emerald-700">Date Completed</th>
                            ...
                            @forelse($completedOrRejected as $doc)
                                <tr>
                                    ...
                                    <td class="px-3 py-2 text-sm text-gray-600">
                                        @php
                                            $completedDate = '-';
                                            if (isset($doc['updated_at']) && $doc['updated_at']) {
                                                $completedDate = \Carbon\Carbon::parse($doc['updated_at'])->format('Y-m-d');
                                            }
                                        @endphp
                                        {{ $completedDate }}
                                    </td>
