        ...
        <div class="flex-1">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    <form class="relative" method="GET" action="{{ route('handler.pending') }}">
                            ...
                            @forelse($pendingDocuments as $doc)
                                <tr>
                                    ...
                                    <td class="px-3 py-2">
                                        ...
                                        <a href="{{ route('handler.initial', ['document' => $doc['id']]) }}" class="ml-2 text-emerald-700 hover:underline text-xs">Process</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
