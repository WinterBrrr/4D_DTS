        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-2xl shadow p-8">
                ...
                <div class="mt-8 flex gap-4">
                    ...
                    <a href="{{ route('handler.dashboard') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg font-semibold hover:bg-gray-300 transition">Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
