    ...
    <div class="mx-auto w-full max-w-[1400px] px-4 py-6 flex gap-6">
        ...
        <div class="flex-1">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-emerald-700">Upload Document</h1>
            ...
            <form method="POST" action="{{ route('upload.store') }}" enctype="multipart/form-data" class="mt-4 space-y-6">
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('handler.dashboard') }}" class="inline-flex items-center px-6 py-2.5 border-2 border-gray-300 rounded-lg text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200">
