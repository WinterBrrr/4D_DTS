...
<x-layouts.app :title="'Profile'">
    <div class="mx-auto w-full max-w-[1400px] px-4 py-6 flex gap-6">
        ...
        <div class="flex-1">
            ...
            {{-- Instant preview script for profile photo --}}
            <script>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="mt-6 text-sm space-y-2">
                        <div class="grid grid-cols-3 items-center">
                            ...
                            <div class="col-span-2 text-right">
                                @php($role = ucfirst(Session::get('user_role', 'user')))
                ...
                {{-- Profile Details / Forms (light only) --}}
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm ring-1 ring-black/5">
                        ...
                        <form class="grid grid-cols-1 md:grid-cols-2 gap-4" method="POST" action="{{ route('profile.update') }}">
                            ...
                            <div>
                                ...
                                <select name="identity" class="w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500">
                                    @php($idVal = $profile->identity ?? '')
                                    <option value="">Select...</option>
                                    <option value="Teacher" {{ $idVal==='Teacher' ? 'selected' : '' }}>Teacher</option>
                                    <option value="Student" {{ $idVal==='Student' ? 'selected' : '' }}>Student</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input name="email" type="email" value="{{ $pUser->email ?? Session::get('user_email', '') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500" />
                            </div>
                            <div>
